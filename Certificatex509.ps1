# Create Certificate X509 digital  to be used for server-based authentication between Microsoft Dynamics 365 Server and the SharePoint server
# Change in the variable $ hostName - to your crm server name for example "crm-microsoft01.domen.ru"
# create folders "certs"   c:\certs

$certPassword = "Passs$w0rDD(007)!";
$hostName = "crm-microsoft01.domen.ru";
